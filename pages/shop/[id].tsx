      ...
      <div className='flex gap-[30px]'>
            ...
            <div>
              ...
              <div>
                ...
                <p className="w-[550px] text-sm" >{ProductDetail?.desc}</p>
              </div>
        ...
        <div className='mt-[100px]'>
          ...
          <div>
          <p className=' w-[850px] mt-[20px] text-sm'>Loreum ipsum door sit amet, consectur adipiscing elit. Leo augue nibhLoreum ipsum doLoreum ipsum door sit amet, consectur adipiscingLoreum ipsum door sit amet, consectur adipiscingor sit amet, consectur adipiscing elit. Leo augue nibhr sit amet, consectur adipiscing elit. Leo augue nibh</p>

          <p className=' w-[850px] mt-[20px] text-sm'>Loreum ipsum door sit amet, consectur adipiscing elit. LeLoreum ipsum door sit amet, consectur adipiscingLoreum ipsum door sit amet, consectur adipiscingo augue nibhLoreum ipsum door sit amet, consectur adipiscing elit. Leo augue nibhr sit amet, consectur adipiscing elit. Leo augue nibh</p>
          <ul>
            <li></li>
          </ul>
          </div>
